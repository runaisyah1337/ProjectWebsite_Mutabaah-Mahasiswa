...
const testTimeout = slowMoMs > 0
    ? 30 * 60 * 1000 // 30 menit — sangat longgar untuk demo dengan kecepatan sangat lambat
...
module.exports = defineConfig({
    ...
    expect: { timeout: slowMoMs > 0 ? 120000 : 10000 },
    ...
    use: {
        ...
        actionTimeout: slowMoMs > 0 ? 120000 : 10000,
        navigationTimeout: slowMoMs > 0 ? 120000 : 15000
    },
